...
const Login = () => {
  const [signInWithGoogle, user_g, loading_g, error_g] =
  ...
  return (
    <div>
      <form onSubmit={handleSubmit(onSubmit)}>
        <h1 className=" font-bold text-4xl text-center text-red-600">
          Sign In{" "}
        </h1>
        <div className="grid justify-center items-center gap-1 mt-10">
          ...
          <Link className="m-2 text-red-600 font-bold" to="/resetPassword">
            {" "}
            Forget Password
          </Link>
          <p className="m-2 ">
            ...
            <Link className="my-1 text-primary font-bold" to="/register">
              {" "}
              Create new account
            </Link>{" "}
          </p>
          ...
          <input
            className="btn btn-primary font-bold mx-auto w-80 "
            type="submit"
            value="Sign In"
          />
        </div>
      ...
      <div className="grid items-center justify-center">
        <button
          ...
          className="btn btn-outline btn-primary w-80 font-bold "
        >
          {" "}
          Google Sign In
        </button>
