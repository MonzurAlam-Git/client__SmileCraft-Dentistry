                ...
                <div className='grid grid-flow-row justify-center items-center bg-white-500 p-12 m-24'>
                    ...
                    <div className='grid grid-flow-row'>
                        ...
                        <div className="form-control  ">
                            ...
                            {/* error handle  */}
                            <label className="label">
                                {errors.email?.type === 'required' && <p className='text-red-500 font-bold ml-8' role="alert">{errors.email.message}</p>}
                                {errors.email?.type === 'minLength' && <p className='text-red-500 font-bold ml-8' role="alert">{errors.email.message}</p>}
                            </label>
                        </div>
                        {/* password input */}
                        <div className="form-control  ">
                        ...
                        <Link className='m-2 text-red-600' to=""> Forget Password</Link>
                        <p className='m-2'> New to Doctors Portal? <Link className='my-1 text-primary' to=""> Create new account</Link> </p>
